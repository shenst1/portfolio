...
(function() {
  ...
  portfolioApp.config(function($routeProvider, $locationProvider) {
    ...
    $routeProvider.when('/projects/:list_id', {
...
(function() {
  angular.module('portfolioApp').controller("DashboardController", function($scope, $routeParams, $location, TaskList) {
...
var MessageController = function ($scope, $modal, $log) {
...
(function() {
  angular.module('portfolioApp').controller("ProjectsCtrl", function($scope, $modal, $location, $routeParams, Project, $timeout) {
    var serverErrorHandler;
    $scope.init = function() {
      this.projectService = new Project(serverErrorHandler);
      return $scope.projects = this.projectService.all();
    };
    $scope.createProject = function() {
      var project;
      project = this.projectService.create($scope.newProject);
...
(function() {
  angular.module('portfolioApp').controller("TodoListController", function($scope, $timeout, $routeParams, Task, TaskList) {
...
(function() {
  angular.module('portfolioApp').directive('calendar', function() {
    return {
      restrict: 'E',
      transclude: true,
      replace: true,
...
(function() {
  angular.module('portfolioApp').directive('nonBlank', function() {
    return {
      restrict: 'A',
...
(function() {
  angular.module('portfolioApp').directive('uiSortableExt', function() {
    return {
      restrict: 'A',
      link: function(scope, element, attrs) {
        var toggleSortable;
...
(function() {
  angular.module('portfolioApp').factory('Project', function($resource, $http) {
    var Project;
    return Project = (function() {
      function Project(errorHandler) {
        var defaults;
        this.service = $resource('/api/projects/:id', {
          id: '@id'
        }, {
          update: {
            method: 'PATCH'
      ...
      Project.prototype.create = function(attrs) {
        new this.service({
          project: attrs
        }).$save((function(project) {
          return attrs.id = project.id;
        }), this.errorHandler);
        return attrs;
      };
      ...
      Project.prototype.update = function(project, attrs) {
      ...
      Project.prototype.find = function(id, successHandler) {
...
(function() {
  angular.module('portfolioApp').factory('TaskList', function($resource, $http) {
    var TaskList;
...
(function() {
  angular.module('portfolioApp').factory('Task', function($resource, $http) {
    var Task;
